<?php
    ...
    if(!isUserLoggedIn()){
        ...
        $messaggio_finale = $pieces[0]["bozza"].$_SESSION["id_utente"].$pieces[1]["bozza"].($_GET["number"] > 1 ? $_GET["number"].$pieces[2]["bozza"] : "").$dbh->getEventFromId($tickets[0]["id_evento"])["titolo"];
